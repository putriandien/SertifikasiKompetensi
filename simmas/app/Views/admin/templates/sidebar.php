...
<div class="mobile-header" id="mobileHeader">
    ...
    <div class="mobile-logo">
        ...
        <div>
            ...
            <div class="mobile-school-name">Panel Admin</div>
        </div>
    </div>
</div>
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="logo">
            ...
            <div>
                ...
                <div class="school-name">Panel Admin</div>
            </div>
        </div>
    </div>
    ...
    <nav class="nav-menu">
        <?php 
            $uri = service('uri'); 
            $segment1 = $uri->getSegment(1); // ambil 'admin'
            $segment2 = $uri->getSegment(2); // ambil 'dashboard' / 'dudi' / dll
            ?>
        <div class="nav-section">
            <div class="nav-section-title">Main Menu</div>
            <?php if (session()->get('role') === 'admin'): ?>
            <a href="/admin/dashboard" class="nav-link  <?= ($segment1 == 'admin' && $segment2 == 'dashboard') ? 'active' : '' ?>">
                <div class="nav-icon">📊</div>
                <span class="nav-text">Dashboard</span>
            </a>
            <a href="/admin/dudi" class="nav-link <?= ($segment1 == 'admin' && $segment2 == 'dudi') ? 'active' : '' ?>">
                <div class="nav-icon">🏢</div>
                <span class="nav-text">DUDI</span>
            </a>
            <a href="/admin/pengguna" class="nav-link <?= ($segment1 == 'admin' && $segment2 == 'pengguna') ? 'active' : '' ?>">
                <div class="nav-icon">👥</div>
        ...
        <div class="nav-section">
            ...
            <a href="/admin/pengaturan" class="nav-link <?= ($segment1 == 'admin' && $segment2 == 'pengaturan') ? 'active' : '' ?>">
