...
<div class="mobile-header" id="mobileHeader">
    ...
    <div class="mobile-logo">
        ...
        <div>
            ...
            <div class="mobile-school-name">Panel Siswa</div>
        </div>
    </div>
</div>
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="logo">
            ...
            <div>
                ...
                <div class="school-name">Panel Siswa</div>
            </div>
        </div>
    </div>
    ...
    <nav class="nav-menu">
        <?php 
            $uri = service('uri'); 
            $segment1 = $uri->getSegment(1); // ambil 'siswa'
            $segment2 = $uri->getSegment(2); // ambil 'dashboard' / 'dudi' / dll
        ?>
        <div class="nav-section">
            <div class="nav-section-title">Main Menu</div>
            <?php if (session()->get('role') === 'siswa'): ?>
            <a href="/siswa/dashboard" class="nav-link <?= ($segment1 == 'siswa' && $segment2 == 'dashboard') ? 'active' : '' ?>">
                <div class="nav-icon">📊</div>
                <span class="nav-text">Dashboard</span>
            </a>
            <a href="/siswa/dudi" class="nav-link <?= ($segment1 == 'siswa' && $segment2 == 'dudi') ? 'active' : '' ?>">
                <div class="nav-icon">🏢</div>
        ...
        <div class="nav-section">
            ...
            <a href="/siswa/jurnal-harian" class="nav-link <?= ($segment1 == 'siswa' && $segment2 == 'jurnal-harian') ? 'active' : '' ?>">
                <div class="nav-icon">📋</div>
                <span class="nav-text">Jurnal Harian</span>
            </a>
            <a href="/siswa/magang" class="nav-link <?= ($segment1 == 'siswa' && $segment2 == 'magang') ? 'active' : '' ?>">
                <div class="nav-icon">🎯</div>
